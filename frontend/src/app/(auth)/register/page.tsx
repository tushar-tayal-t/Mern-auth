        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
          ...
          <div className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)}>
                  ...
                  {...register("name", 
                    {
                      ...
                      pattern: {
                        value: /^[A-Za-z0-9.@]+$/, // Only letters, digits, dot, and @
                        message: "Name can only contain letters, digits, . and @"
                      }
                    }
                  )} 
              ...
              >{!btnLoading ? "Sign Up" : <span className='items-center'>Signing In... <Loader2 className='animate-spin inline'/></span>}</button>
            </form>
            <p className="text-sm text-gray-500 mt-3">Have an account? <Link className='text-blue-500' href={"/login"}>Login</Link></p>
          </div>
        </div>
      </section>
    </div>
